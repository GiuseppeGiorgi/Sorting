...
public class HeapSortTest {
	...
	@Test
	public void testHsort1() {
		
		sort.sort(lista, new Field1Comparator());
	...
	@Test
	public void testHsort2() {
		
		sort.sort(lista, new Field2Comparator());
	...
	@Test
	public void testHsort3() {
		
		sort.sort(lista, new Field3Comparator());
